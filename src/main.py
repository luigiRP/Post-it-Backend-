...
def callback():
    ...
    if userinfo_response.json().get("email_verified"):
        ...
        users_username = userinfo_response.json()["given_username"]
    else:
    ...
    # by Google
    user = User(
        id=unique_id, username=users_username, name=users_name, email=users_email)

    # Doesn't exist? Add it to the database.
    if not User.get(unique_id):
        User.create(unique_id, users_username, users_name, users_email)
